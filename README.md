# UNC AI Bootcamp Week 6 Challenge - Movie Review Data Aggregator

## Project Description
This project, developed as part of the UNC AI Bootcamp Week 6 Challenge, involves creating a recommendation system to help users find movie reviews and related movies. The script fetches data from two APIs - The New York Times and The Movie Database (TMDB) - merges the data, and processes it for further analysis and recommendation purposes.

## Key Features
- **Data Sourcing**: Fetches movie review data from The New York Times API.
- **Data Enrichment**: Retrieves additional movie details from The Movie Database API.
- **Data Processing**: Merges and cleans the data for easy consumption and analysis.

## Installation and Setup
Ensure you have Python installed on your system. The project requires several Python packages, which can be installed via pip:
```bash
...
UNC AI Bootcamp Week 6 Challenge
